...
const RegOpenKeyExW = lib.func("int32 __stdcall RegOpenKeyExW(void *hKey, const char16_t *lpSubKey, uint32 ulOptions, uint32 samDesired, _Out_ void **phkResult)");
const RegCreateKeyExW = lib.func("int32 __stdcall RegCreateKeyExW(void *hKey, const char16_t *lpSubKey, uint32 Reserved, void *lpClass, uint32 dwOptions, uint32 samDesired, void *lpSecurityAttributes, _Out_ void **phkResult, _Out_ uint32 *lpdwDisposition)");
const RegCloseKey = lib.func("int32 __stdcall RegCloseKey(void *hKey)");
const RegDeleteKeyW = lib.func("int32 __stdcall RegDeleteKeyW(void *hKey, const char16_t *lpSubKey)");
const RegDeleteValueW = lib.func("int32 __stdcall RegDeleteValueW(void *hKey, const char16_t *lpValueName)");
const RegQueryInfoKeyW = lib.func("int32 __stdcall RegQueryInfoKeyW(void *hKey, void *lpClass, void *lpcchClass, void *lpReserved, _Out_ uint32 *lpcSubKeys, _Out_ uint32 *lpcbMaxSubKeyLen, void *lpcbMaxClassLen, _Out_ uint32 *lpcValues, _Out_ uint32 *lpcbMaxValueNameLen, _Out_ uint32 *lpcbMaxValueLen, void *lpcbSecurityDescriptor, void *lpftLastWriteTime)");
const RegEnumKeyExW = lib.func("int32 __stdcall RegEnumKeyExW(void *hKey, uint32 dwIndex, char16_t *lpName, _Inout_ uint32 *lpcchName, void *lpReserved, void *lpClass, void *lpcchClass, void *lpftLastWriteTime)");
const RegEnumValueW = lib.func("int32 __stdcall RegEnumValueW(void *hKey, uint32 dwIndex, char16_t *lpValueName, _Inout_ uint32 *lpcchValueName, void *lpReserved, _Out_ uint32 *lpType, void *lpData, _Inout_ uint32 *lpcbData)");
const RegQueryValueExW = lib.func("int32 __stdcall RegQueryValueExW(void *hKey, const char16_t *lpValueName, void *lpReserved, _Out_ uint32 *lpType, void *lpData, _Inout_ uint32 *lpcbData)");
const RegSetValueExW = lib.func("int32 __stdcall RegSetValueExW(void *hKey, const char16_t *lpValueName, uint32 Reserved, uint32 dwType, void *lpData, uint32 cbData)");
/**
...
export const backend = {
    ...
    createKey(hkey, subKey, access) {
        ...
        const status = RegCreateKeyExW(toHKEY(hkey), subKey, 0, null, 0, access, null, handleArr, dispositionArr);
        if (status !== ERROR_SUCCESS) {
    ...
    queryInfoKey(hkey) {
        ...
        const status = RegQueryInfoKeyW(toHKEY(hkey), null, null, null, subKeyCount, maxSubKeyLen, null, valueCount, maxValueNameLen, maxValueLen, null, lastWriteTime);
        if (status !== ERROR_SUCCESS) {
