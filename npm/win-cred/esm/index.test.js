...
import { CredType, decodeSecret, encodeSecret, isAvailable, listCredentials, readCredential, readSecret, removeCredential, saveCredential, } from "./index.js";
...
test("win-cred::credential manager is unavailable on non-windows runtimes", { skip: WINDOWS }, () => {
...
test("win-cred::save/read/remove credential (Windows, dangerous)", { skip: !WINDOWS || !CREDENTIAL_MANAGER_MUTATIONS }, () => {
    if (!WINDOWS || !CREDENTIAL_MANAGER_MUTATIONS)
        return;
    saveCredential({
